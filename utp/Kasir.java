    ...
    public void tampilkanDaftarMeja() {
        ...
        for (int i = 0; i < daftarMeja.length; i++) {
            if (daftarMeja[i].isKosong())
                ...
                System.out.printf("\nMeja %d (terisi oleh pelanggan %s)", i + 1,
        ...
        while (pilihan != 0) {
            ...
            switch (pilihan) {
                ...
                case 2:
                    ...
                    tambahPelanggan(Integer.parseInt(num), new Pelanggan(scanner.nextLine()));
                    break;
                case 3:
                ...
                case 5:
                    ...
                    if (gross <= 0)
                        System.out.printf("Meja %s tidak memiliki pesanan", num);
                    else
                        System.out.printf("Harga pesanan di meja %s adalah %d", num, gross);
                    System.out.println();
                    break;
                case 6:
                    System.out.print("Masukkan nomor meja: ");
                    ...
                    if (daftarMeja[Integer.parseInt(num) - 1].isKosong())
                        System.out.printf("Meja %s tidak memiliki pesanan", num);
                    else {
                        for (Menu menu : daftarMeja[Integer.parseInt(num) - 1].getMenu()) {
                            if (menu == null)
                                continue;
                            System.out.printf("Meja %s - %s memesan %s seharga %s\n", num,
                                    daftarMeja[Integer.parseInt(num) - 1].getPelanggan().getNama(), menu.getNama(),
                                    menu.getHarga());
                        }
                    }
                    System.out.println();
