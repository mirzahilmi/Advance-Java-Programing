...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    DataMerchant.merchants =
      DataMerchant.tambahMerchant(
        new Merchant("Antaguese", "Baguette", 782_900.68)
      );

    DataMerchant.merchants =
      DataMerchant.tambahMerchant(
        new Merchant("Mercurious", "Ratatouille", 34_389_900.32)
      );

    DataMerchant.merchants =
      DataMerchant.tambahMerchant(
        new Merchant("Andawgius", "Croissant", 83_982_900.99)
      );
    ...
    DataMerchant.merchants =
      DataMerchant.tambahMerchant(
        new Merchant("Antaguese", "Noodles", 1_489_900)
      );
  }
}
