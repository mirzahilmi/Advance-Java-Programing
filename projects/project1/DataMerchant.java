...
public class DataMerchant {
  ...
  static Merchant[] tambahMerchant() {
    Merchant merchant = new Merchant(
      scx.nextLine("Nama\t\t: "),
      scx.nextLine("Nama Produk\t: "),
      scx.nextDouble("Harga Makanan\t: ")
    );
  ...
  static Merchant cariMerchant(String param) {
    for (Merchant merchant : merchants) if (
      merchant.getNamaMerchant() == param
    ) return merchant;

    System.out.println(
      "No record matching the provided data was found in the database. Please verify the data and try again\n"
    );
    return null;
  }
  ...
  static void tampilMerchant(Merchant merchant) {
    ...
    System.out.printf(
      ...
      merchant.getNamaProduk(),
      merchant.getHargaMakanan()
    );
  }
  ...
  private static boolean isUnique(Merchant thisMerchant) {
    for (Merchant merchant : merchants) if (
      merchant.getNamaMerchant() == thisMerchant.getNamaMerchant()
    ) return false;
    return true;
  }
}
